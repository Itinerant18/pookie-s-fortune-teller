...
-- Add birth details and full_name to user_profiles if missing
...
ALTER TABLE public.user_profiles ADD COLUMN IF NOT EXISTS birth_place VARCHAR(255);
ALTER TABLE public.user_profiles ADD COLUMN IF NOT EXISTS birth_lat DECIMAL(10, 8);
ALTER TABLE public.user_profiles ADD COLUMN IF NOT EXISTS birth_lon DECIMAL(11, 8);

  ...
  "rounded-xl text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        glass: "glass-card",
        cosmic: "glass-card aurora-border hover:shadow-[0_0_40px_hsl(260,80%,60%,0.2)]",
        prediction: "glass-card border border-[hsl(260,80%,60%,0.2)] hover:border-[hsl(260,80%,60%,0.4)] hover:shadow-[0_0_30px_hsl(260,80%,60%,0.15)]",
      },
    },
    defaultVariants: {
      variant: "default",
